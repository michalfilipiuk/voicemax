...
export default function VoiceTestIntroScreen() {
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
        <View style={styles.headerSection}>
          ...
          <ThemedText type="headlineLarge" style={styles.title}>
            Let's measure your voice
          </ThemedText>
          <ThemedText
            type="bodyLarge"
            style={[styles.subtitle, { color: contentNormal }]}
          >
            We'll analyze your voice pitch to create a personalized training
      ...
      <Footer
        variant="oneButton"
        primaryLabel={isRequestingPermission ? 'Requesting...' : 'Start Voice Test'}
